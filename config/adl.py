...
class AdversarialDebiasing(Transformer):
    ...
    def fit(self, dataset, protected_features):
        ...
        with tf.variable_scope(self.scope_name):
            ...
            for epoch in range(self.num_epochs):
                ...
                for i in range(num_train_samples//self.batch_size):
                    ...
                    batch_protected_attributes = protected_features[batch_ids]
    ...
    def predict(self, dataset, protected_features):
        ...
        self.pred_labels = self.sess.graph.get_tensor_by_name("debiased_classifier/classifier_model/Sigmoid:0")
        self.features_ph = self.sess.graph.get_tensor_by_name("debiased_classifier/Placeholder:0")
        self.true_labels_ph = self.sess.graph.get_tensor_by_name("debiased_classifier/Placeholder_2:0")
        self.protected_attributes_ph = self.sess.graph.get_tensor_by_name("debiased_classifier/Placeholder_1:0")
        self.keep_prob = self.sess.graph.get_tensor_by_name("debiased_classifier/Placeholder_3:0")
